#!/usr/bin/env node
// Build the slim extension-engine pack for one platform (Phase 2: desktop/scripts/engine-pack.mjs).
//
//   node pack.mjs --platform win-x64|mac-arm64|mac-x64|linux-x64 [--cache <dir>] [--out <dir>]
//
...
import { extractTarGz, extractZip, writeZip, sha256File, dirSize, readZipEntry } from './lib/archive.mjs';
