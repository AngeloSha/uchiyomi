...
export default async function komgaCompatRoutes(app: FastifyInstance) {
  ...
  // chapter the list had just handed out. Nothing here reads the setting until something could consume it:
  // the cheap shape test (isGhostId) gates it, and on the single-book route below a tombstone does too.
