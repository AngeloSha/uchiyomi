 ...
 * which is what lib/ownedCatalog's booksSrc (L70-77) hands the list and what lib/komgaProgress (L49-55)
 * counts -- the whole Komga surface treats that one quantity as the chapter number. Matching the RAW
 * lib_books.number instead would leave an overridden chapter listed TWICE: a book whose filename parsed as 0
